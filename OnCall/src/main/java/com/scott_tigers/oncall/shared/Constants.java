...
public class Constants {
    ...
    public static final String CIT_START_DATE = "2020-06-29";
    ...
    public static final int ENGINE_TICKET_TRAILING_DAYS = 3;
    public static final int ENGINE_TICKETS_ON_THE_QUEUE = 7;
